...
static const char * const lookupTableGovernorMode[] = {
    "OFF", "PASSTHROUGH", "STANDARD", "MODE1", "MODE2", "MODE3", "MODE4",
};
...
// PG_GOVERNOR_CONFIG
    ...
    { "gov_tta_gain",               VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 200 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_tta_gain) },
    { "gov_tta_limit",              VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 50 }, PG_GOVERNOR_CONFIG, offsetof(governorConfig_t, gov_tta_limit) },
